...
<div class="content">
    <div class="btn-controls">
        <div class="btn-box-row row-fluid" >
            <button class="btn-box span12" style="background: #190B28; ">
                <b style="color:#fff; font-family: cursive;">Online Library Management System</b>
            </button>
        </div>
                ...
                <div class="module-body">
                    <form class="form-horizontal row-fluid" id="findbookform">
                        <div class="control-group">
                            <label class="control-label">Book Name or author</label>
                            <div class="controls">
                                <div class="span9">
                                    <textarea class="span12" rows="2"></textarea>
                                </div>
                                <div class="span3">
                                    <a class="btn homepage-form-submit " style="background-color:  #190B28; color:#fff"><i class="icon-search"></i> Search</a>
                                </div>
                            </div>
                        </div>
                    </form>
